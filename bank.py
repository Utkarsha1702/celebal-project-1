...
if __name__ == '__main__':
    cust1 = BankAccount(name='utkarsha', mobile_no=7666164113, initial_depo=1000, pin=126)
    cust2 = BankAccount(name='saiee', mobile_no=9960998291, initial_depo=2000, pin=517)
